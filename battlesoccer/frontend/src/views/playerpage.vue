            ...
            <div class="container">
                <div class="row">
	                <div class="col-md-6 ml-auto mr-auto">
        	           <div class="profile">
	                        <div class="avatar">     
<img :src="players.pic + '?'+ new Date().getTime()" class=res>
                        </div>
                         <div class="name">
            ...
            :to="{ name: 'Addplayer',
             ...
             ><i class="fa fa-edit btn btn-just-icon btn-link btn-twitter"  style="margin-top:-60px" ></i>
            </router-link>
            <div v-if="isUser"  class="upload-btn-wrapper">
  <button class="btn"><i class="fa fa-camera btn btn-just-icon btn-link btn-twitter"></i></button>
